      ...
      <div className="bg-white dark:bg-zinc-900 border border-zinc-150 dark:border-zinc-850 p-6 rounded-2xl shadow-xs space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <button
            ...
            className={`py-4 px-4 rounded-xl border-2 flex flex-col items-center justify-center gap-2 cursor-pointer transition-all ${
              lang === 'bn'
                ? 'bg-emerald-50 border-emerald-500 text-emerald-400 font-bold dark:bg-emerald-950/20'
                : 'bg-transparent border-zinc-200 dark:border-zinc-800 text-zinc-500 hover:bg-zinc-50/50 dark:hover:bg-zinc-850/50'
            }`}
          >
      ...
      <div className="bg-white dark:bg-zinc-900 border border-zinc-150 dark:border-zinc-850 p-6 rounded-2xl shadow-xs space-y-4">
        ...
        <div className="pt-4 border-t border-zinc-100 dark:border-zinc-800 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
          ...
          <button
            ...
            className="px-5 py-3.5 bg-emerald-600 hover:bg-emerald-700 font-extrabold text-white rounded-xl text-sm flex items-center justify-center gap-2 cursor-pointer shadow-xs transition-colors"
          >
