  ...
  return (
    <div className="space-y-6 no-select">
      ...
      <motion.div 
        ...
        className="bg-white dark:bg-zinc-900 text-zinc-900 dark:text-white border border-zinc-950 dark:border-zinc-700 rounded-3xl p-6 sm:p-8 shadow-sm dark:shadow-xl relative overflow-hidden"
      >
        ...
        <div className="grid grid-cols-2 gap-4 mt-8 pt-6 border-t border-zinc-950 dark:border-zinc-700 relative z-10">
          <div className="flex items-center gap-3">
            <div className="p-3 rounded-2xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-950 dark:border-zinc-700 text-amber-600 dark:text-amber-500">
          ...
          <div className="flex items-center gap-3">
            <div className="p-3 rounded-2xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-950 dark:border-zinc-700 text-emerald-600 dark:text-emerald-400">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <motion.div 
          ...
          className="bg-white dark:bg-zinc-900 border border-zinc-950 dark:border-zinc-700 p-6 rounded-2xl shadow-xs flex items-center justify-between"
        >
        ...
        <motion.div 
          ...
          className="bg-white dark:bg-zinc-900 border border-zinc-950 dark:border-zinc-700 p-5 rounded-2xl shadow-xs flex items-center gap-4"
        >
          {/* Circular progress */}
      ...
      <div className="space-y-3">
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-950 dark:border-zinc-700 rounded-2xl overflow-hidden shadow-xs">
      ...
      <div className="pt-6 border-t border-zinc-950 dark:border-zinc-700">
        <AnalyticsManager 
          customers={customers}
