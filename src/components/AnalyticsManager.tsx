...
export default function AnalyticsManager({ customers, transactions, lang }: AnalyticsManagerProps) {
 ...
 <div className="lg:col-span-2 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-5 rounded-2xl shadow-md space-y-4">
 <div>
 ...
 {/* Dues bar */}
 <div className="w-3.5 sm:w-5 relative flex justify-center transition-transform">
 <div 
