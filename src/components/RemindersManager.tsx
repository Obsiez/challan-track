...
export default function RemindersManager({
  ...
  return (
    <div className="space-y-6 no-select">
      ...
      <div className="bg-white dark:bg-zinc-900 border border-zinc-150 dark:border-zinc-850 p-6 rounded-2xl shadow-xs space-y-4">
        ...
        <div className="pt-4 border-t border-zinc-100 dark:border-zinc-800 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <button
              ...
              className="px-4 py-3 bg-amber-500 text-zinc-950 hover:bg-amber-600 font-extrabold rounded-xl text-xs flex items-center gap-1.5 cursor-pointer shadow-xs"
            >
      ...
      <AnimatePresence>
        {showAddForm && (
          <motion.form
            ...
            className="bg-white dark:bg-zinc-900 border border-zinc-150 dark:border-zinc-850 p-5 rounded-2xl shadow-md space-y-4"
          >
      ...
      <div className="space-y-3">
        {reminders.length === 0 ? (
          <div className="bg-white dark:bg-zinc-900 border border-zinc-150 dark:border-zinc-850 p-10 text-center rounded-2xl text-zinc-400">
            ...
            {reminders.map(rem => (
              <div 
                ...
                className={`p-5 rounded-2xl border transition-all flex items-center justify-between gap-4 ${
                  rem.active 
                    ? 'bg-white border-zinc-150 dark:bg-zinc-900 dark:border-zinc-850 shadow-xs' 
