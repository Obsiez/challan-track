...
export default function App() {
  ...
  if (!user) {
    return (
      <div id="auth_view" className="min-h-screen bg-zinc-50 dark:bg-zinc-950 flex flex-col items-center justify-center p-4 sm:p-6 no-select transition-colors">
        ...
        <div className="w-full max-w-md bg-white dark:bg-zinc-900 rounded-3xl border border-zinc-250 dark:border-zinc-800 p-6 sm:p-8 shadow-2xl space-y-6">
          
          {/* Logo Heading */}
          <div className="text-center space-y-3">
            <div className="mx-auto w-16 h-16 rounded-2xl bg-emerald-600 flex items-center justify-center text-white shadow-lg shadow-emerald-100 dark:shadow-none">
              <BookOpen className="w-8 h-8 stroke-[2.5]" />
            </div>
            <div>
              <h1 className="text-2xl sm:text-3xl font-black text-zinc-900 dark:text-white tracking-tight">{t.appName}</h1>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3.5">
              <div className="p-2.5 bg-rose-50 dark:bg-rose-950/30 text-rose-600 dark:text-rose-400 rounded-xl mt-0.5 shrink-0">
            ...
            <div className="flex items-start gap-3.5">
              <div className="p-2.5 bg-emerald-50 dark:bg-emerald-950/30 text-emerald-600 dark:text-emerald-400 rounded-xl mt-0.5 shrink-0">
            ...
            <div className="flex items-start gap-3.5">
              <div className="p-2.5 bg-amber-50 dark:bg-amber-950/30 text-amber-600 dark:text-amber-400 rounded-xl mt-0.5 shrink-0">
          ...
          <div className="space-y-3 pt-2">
            <button
              ...
              className="w-full py-4.5 bg-emerald-600 hover:bg-emerald-700 text-white font-black rounded-2xl flex items-center justify-center gap-3 shadow-lg shadow-emerald-500/20 hover:scale-[1.01] transition-all cursor-pointer text-base"
              id="google_signin_btn"
            >
              <svg className="h-5 w-5 shrink-0 text-white fill-current" viewBox="0 0 24 24">
                <path
            ...
            <button
              ...
              className="w-full py-4 bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-750 text-zinc-800 dark:text-zinc-100 font-extrabold rounded-2xl flex items-center justify-center gap-2 border border-zinc-200 dark:border-zinc-750 hover:scale-[1.01] transition-all cursor-pointer text-sm"
              id="guest_signin_btn"
            >
              {t.guestSignIn}
            </button>
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-800 dark:text-zinc-200 flex flex-col no-select pb-24 sm:pb-0 transition-colors">
      ...
      <header className="bg-white dark:bg-zinc-900 border-b border-zinc-150 dark:border-zinc-850 py-3.5 px-4 sm:px-6 sticky top-0 z-30 shadow-xs">
        ...
        {appDialog && appDialog.isOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="bg-white dark:bg-zinc-900 border border-zinc-150 dark:border-zinc-800 rounded-3xl p-6 sm:p-7 w-full max-w-sm shadow-2xl relative z-10 text-center space-y-6"
            >
